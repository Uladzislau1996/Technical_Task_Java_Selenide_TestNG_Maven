...
public class MainPageLocators {
    ...
    protected SelenideElement couponDropDown = $x("//*[@id='price_bets']//div/span[(text())=" +
            "'Подтверждать']");
    protected SelenideElement couponDropDownAcceptWhenRise = $x("//span[normalize-space(text())=" +
            "'Принять при повышении']");
    protected SelenideElement couponDropDownConfirm = $x("//*[@class='multiselect__content']//" +
            "*[(text())='Подтверждать']");
    ...
    protected SelenideElement couponPromoCodeTextField = $x("//div[@title='Промо-код']" +
